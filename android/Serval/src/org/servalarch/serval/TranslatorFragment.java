...
public class TranslatorFragment extends Fragment {
	...
	this.translatorButton.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View view) {
			...
			if (success) {
			    ...
			    ((TextView) getView().findViewById(R.id.error_msg)).setText(getString(R.string.no_dummy));
	...
	if (dev.exists() && dev.canRead()) {
	    try {
		BufferedReader in = new BufferedReader(new InputStreamReader(new FileInputStream(dev)));
