...
enum reactor_state {
    REACTOR_CREATED = 0, REACTOR_INITIALIZED = 1, REACTOR_STARTED = 2, REACTOR_STOPPED = 3
};
...
void pr_set_read(struct poll_reactor_ds*, int fd, reactor_exec exec, void* data);
void pr_set_write(struct poll_reactor_ds*, int fd, reactor_exec exec, void* data);
void pr_set_error(struct poll_reactor_ds*, int fd, reactor_exec exec, void* data);
void pr_set_interest(struct poll_reactor_ds*, int fd, reactor_exec rexec, void* rdata,
...
void pr_add_timeout(struct poll_reactor_ds*, time_t msec, reactor_exec exec, void* data);
