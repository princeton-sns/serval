 ...
 * 
 * @author Erik Nordstršm <enordstr@cs.princeton.edu>
 * 
 */
public abstract class HostCtrlCallbacks {
	 ...
	 * 
	 * @param id
	 *            the ServiceID being registered
	 * @param flags
	 *            flags detailing how this registration should be handled
	 * @param prefixBits
	 *            the number of bits of the ServiceID to register. 0 means the
	 *            entire serviceID.
	 * @param addr
	 *            the address to associate with the ServiceID
	 * @param oldAddr
	 *            the previous address used associated with this registration,
	 ...
	 * 
	 * @param id
	 *            the ServiceID being unregistered
	 * @param flags
	 *            flags detailing how this unregistration should be handled
	 * @param prefixBits
	 *            the number of bits of the ServiceID to unregister. 0 means the
	 *            entire serviceID.
	 * @param addr
	 *            the address associated with the ServiceID
	 */
	 ...
	 * @param retval
	 *            Return value indicating the result of the call that generated
	 *            this event.
	 * @param info
	 *            The service information this events concerns.
	 */
	 ...
	 *            this event.
	 * @param info
	 *            The service information statistics this events concerns.
	 */
