...
public class TestApp {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            hc.addService(new ServiceID("testapp.localdomain"), addr);
			
            Thread.sleep(1000);
			
            hc.getService(new ServiceID("testapp.localdomain"), null);
			
            System.out.println("Waiting 3 seconds for events...");
			
            Thread.sleep(3000);
			
            hc.removeService(new ServiceID("testapp.localdomain"), addr);
