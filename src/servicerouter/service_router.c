...
extern service_resolver *
create_client_service_resolver(struct sockaddr_sv *local, 
...
extern service_resolver *
create_local_service_resolver(struct sockaddr_sv *local,
                              uint32_t capabilities,
                              uint32_t capacity,
...
static int load_config(const char *config_path)
{
    ...
    peer_addr.service.sv_prefix_bits = 0;
...
int main(int argc, char **argv)
{
    ...
    /*create local resolver and prototype remote(client) resolver for
      discovery */
    ...
    resolver = create_local_service_resolver(&resolver_id, capabilities,
                                             DEFAULT_CAPACITY, def_resolver);
    ...
    */
    ...
    /*the stack-path must be initialized and started prior to
